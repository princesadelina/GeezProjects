...
@bot.on(geezbot_cmd(outgoing=True, pattern="gen(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(geezbot_cmd(outgoing=True, pattern="chk(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    query = event.pattern_match.group(1)
...
@bot.on(geezbot_cmd(outgoing=True, pattern="bin(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    query = event.pattern_match.group(1)
...
@bot.on(geezbot_cmd(outgoing=True, pattern="skey(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    query = event.pattern_match.group(1)
...
@bot.on(geezbot_cmd(outgoing=True, pattern="nmap(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    query = event.pattern_match.group(1)
...
@bot.on(geezbot_cmd(outgoing=True, pattern="subd(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    query = event.pattern_match.group(1)
...
@bot.on(geezbot_cmd(outgoing=True, pattern="cekhttp(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    query = event.pattern_match.group(1)
...
\n\n  `{geez}nmap <domain hosts>`\
\n   Usage: to get info bug/host.\
\n\n  `{geez}subd <domain hosts>`\
\n   Usage: to get subdomain bug/host.\
\n\n  `{geez}cekhttp <domain hosts>`\
