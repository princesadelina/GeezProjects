...
# Copyright © Team Geez - Project <https://github.com/Vckyou/GeezProjects>
...
@bot.on(geezbot_cmd(outgoing=True, pattern="inviteall (.*)"))
...
CMD_HELP.update({
    "inviteall":
        f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{geez}inviteall groups username`\
