...
@bot.on(geezbot_cmd(pattern="gdauth(?: |$)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern="gdreset(?: |$)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern="gdf (mkdir|rm|check) (.*)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern="gdabort(?: |$)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern="gd(?: |$)(.*)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern="gdfset (put|rm)(?: |$)(.*)", outgoing=True))
