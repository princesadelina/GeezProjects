...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"magisk$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"pixeldl(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
...
CMD_HELP.update(
    {
        "android": f">`{geez}magisk`"
        "\nGet latest Magisk releases"
        f"\n\n>`{geez}device <codename>`"
        "\nUsage: Get info about android device codename or model."
        f"\n\n>`{geez}codename <brand> <device>`"
        "\nUsage: Search for android device codename."
        f"\n\n>`{geez}pixeldl` **<download.pixelexperience.org>**"
        "\nUsage: Download pixel experience ROM into your userbot server."
        f"\n\n>`{geez}specs <brand> <device>`"
