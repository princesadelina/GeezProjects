...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"(ascii|asciis)$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"asciibg(?: |$)(.*)"))
async def _(event):
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"(mirror|flip|ghost|bw|poster)$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"rotate(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern="wast$"))
async def hmm(event):
    if not event.reply_to_msg_id:
        await event.edit("`Reply to Any media..`")
        return
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"icircle(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"scircle(?: |$)(.*)"))
async def shiv(event):
    if not event.reply_to_msg_id:
        await event.edit("Reply to any media.")
        return
