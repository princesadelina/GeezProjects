...
@bot.on(geezbot_cmd(outgoing=True, pattern="carbon1"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern="carbon2"))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
    await e.edit("`Processing..`")
...
@bot.on(geezbot_cmd(outgoing=True, pattern="carbon3"))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
    await e.edit("`Processing..`")
...
@bot.on(geezbot_cmd(outgoing=True, pattern="carbon4"))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
    await e.edit("`Processing..`")
...
@bot.on(geezbot_cmd(outgoing=True, pattern="carbon5"))
async def carbon_api(e):
    """ A Wrapper for carbon.now.sh """
    await e.edit("`Processing..`")
...
CMD_HELP.update({
    "carbon":
    f"`{geez}carbon`value <values=1,2,3,4,5>\
