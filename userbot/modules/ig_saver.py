...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"igsaver(?: |$)(.*)"))
...
CMD_HELP.update({"ig_saver": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{geez}igsaver`"
                 f"\n↳ : Download Postingan di Instagram, Silahkan Salin Link Postingan Instagram Yang Ingin Anda Download Terus Kirim Link, Lalu Reply dan Ketik `{geez}igsaver`"})
