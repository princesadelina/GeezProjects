...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"fban(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"unfban(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"addf(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"delf$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"listf$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"clearf$"))
async def delf(event):
...
CMD_HELP.update({"fban": f">`{geez}fban <id/username> <reason>`"
