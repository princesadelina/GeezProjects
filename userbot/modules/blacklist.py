...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
...
CMD_HELP.update({"blacklist": f">`{geez}listbl`"
