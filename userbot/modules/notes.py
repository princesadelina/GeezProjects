...
@bot.on(geezbot_cmd(outgoing=True, pattern="notes$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"clear (\w*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"save (\w*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern="rmbotnotes (.*)"))
...
\n\n`{geez}save` <notename> <notedata> or reply to a message with .save <notename>\
