...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
...
CMD_HELP.update({
    "zipfile":
        f"`{geez}compress` **[optional: <reply to file>]**\
            \nUsage: make files to zip.\
            \n`{geez}addzip` **<reply to file>**\
            \nUsage: add files to zip list.\
            \n`{geez}upzip` **[optional: <zip title>]**\
            \nUsage: upload zip list.\
            \n`{geez}rmzip` **[optional: <zip title>]**\
