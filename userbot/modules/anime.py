...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"a(kaizoku|kayo) ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"char ?(.*)"))
async def character(event):
    ...
    if search_query:
        ...
        await event.edit(f"Format: `{geez}char <character name>`")
        return
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"upcoming ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"scanime ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"smanga ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"sanime ?(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"whatanime"))
