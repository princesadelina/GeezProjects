...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"amag(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"ator(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"aurl(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"aclear(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"apause(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"aresume(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"ashow(?: |$)(.*)"))
...
CMD_HELP.update(
    {
        "aria": f">`{geez}aurl [URL]` (or) >`.amag [Magnet Link]` (or) >`.ator [path to torrent file]`"
        "\nUsage: Downloads the file into your userbot server storage."
        f"\n\n>`{geez}apause (or) .aresume`"
