...
@bot.on(geezbot_cmd(pattern=r"download(?: |$)(.*)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern=r"uploadir (.*)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern=r"upload (.*)", outgoing=True))
...
@bot.on(geezbot_cmd(pattern=r"uploadas(stream|vn|all) (.*)", outgoing=True))
...
CMD_HELP.update({
    "download_upl":
    f"`{geez}download` <link|filename> or reply to media\
\nUsage: Downloads file to the server.\
\n\n`{geez}upload` <path in server>\
\nUsage: Uploads a locally stored file to the chat.\
\n\n`{geez}uploadir` <path in server>\
\nUsage: Uploads a directory stored file to the chat.\
\n\n`{geez}uploadas stream|vn|all` <path in server>\
\nUsage: Uploads a locally stored file to the chat."
})
