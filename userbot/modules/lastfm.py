...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"lastfm$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"lastbio (on|off)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"lastlog (on|off)"))
...
CMD_HELP.update({"lastfm": f">`{geez}lastfm`"
