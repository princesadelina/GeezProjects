...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"purge$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"purgeme"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"edit"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"sd"))
...
CMD_HELP.update({"purge": f">`{geez}purge`"
                 "\nUsage: Purges all messages starting from the reply.",
                 f"purgeme": ">`{geez}purgeme <x>`"
                 "\nUsage: Deletes x amount of your latest messages.",
                 f"del": ">`{geez}del`"
                 "\nUsage: Deletes the message you replied to.",
                 f"edit": ">`{geez}edit <newmessage>`"
                 "\nUsage: Replace your last message with <newmessage>.",
                 f"sd": ">`{geez}sd <x> <message>`"
