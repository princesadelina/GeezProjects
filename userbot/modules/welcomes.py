...
@bot.on(geezbot_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern="checkwelcome$"))
...
@bot.on(geezbot_cmd(outgoing=True, pattern="rmwelcome$"))
...
CMD_HELP.update({
    "welcome":
    f">`{geez}setwelcome <welcome message> or reply to a message with .setwelcome`"
